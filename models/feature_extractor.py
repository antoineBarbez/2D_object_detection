...
def ResNet50FeatureExtractor(kernel_regularizer=None, bias_regularizer=None, **kwargs):
    """
    ...
    layers_override = _LayersOverride(kernel_regularizer=kernel_regularizer, bias_regularizer=bias_regularizer)

    return tf.keras.applications.ResNet50(layers=layers_override, include_top=False, weights="imagenet", **kwargs)
